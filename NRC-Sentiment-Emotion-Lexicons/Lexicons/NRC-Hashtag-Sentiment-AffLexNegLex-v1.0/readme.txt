...
The NRC Hashtag Sentiment Lexicons are automatically generated from the following data source: 
...
************************************************************
NRC Hashtag Affirmative Context Sentiment Lexicon (AffLex) 
and 
NRC Hashtag Negated Context Sentiment Lexicon (NegLex)
************************************************************
